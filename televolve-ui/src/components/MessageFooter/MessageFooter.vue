<template>
  ...
  <div class="message-footer">
    ...
    <input type="text" name="" placeholder="Digite uma mensagem" v-model="pickedEmoji" @keydown.enter="send" />
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="send-input" @click="send">
      <path
